...
s5 <- s %>%
  ...
  dplyr::arrange(date) %>%
  mutate("5y3m" = round(log2(y5 / y0.5), 3)) %>%
  mutate("3y3m" = round(log2(y3 / y0.5), 3)) %>%
  mutate("2y3m" = round(log2(y2 / y0.5), 3)) %>%
  mutate("1y3m" = round(log2(y1 / y0.5), 3)) %>%
  dplyr::select(date, `5y3m`, `3y3m`, `2y3m`, `1y3m`) %>%
