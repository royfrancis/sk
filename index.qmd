...
s %>%
  ...
  dygraph() %>%
  dyRangeSelector() %>%
  dyEvent("2022-02-24", "Russian invasion", labelLoc = "bottom") %>%
  dyEvent("2020-01-30", "Covid outbreak, Brexit", labelLoc = "bottom") %>%
  dyEvent("2020-12-08", "Covid vaccine", labelLoc = "bottom") %>%
