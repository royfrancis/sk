...
#| echo: false
#| label: interest
#| fig-cap: "**Actual interest rates**: Skandia interest rates for home loan over time. Average rate per month is shown. Different lines (colours) denotes different periods of fixed rates (3 months, 1 year, 2 years, 3 years, 5 years)."
